...
public class LwjglWindow2 {
    ...
    // The window handle
	private long window;
	private AbstractRenderer2 renderer;
	...
	public LwjglWindow2(AbstractRenderer2 renderer) {
		this(WIDTH, HEIGHT, renderer, false);
	}

	public LwjglWindow2(AbstractRenderer2 renderer, boolean debug) {
		this(WIDTH, HEIGHT, renderer, debug);
	}

	public LwjglWindow2(int width, int height, AbstractRenderer2 renderer, boolean debug) {
	...
	private void init() {
		...
		*/
		...
		// Enable v-sync
		glfwSwapInterval(1);
		glfwSetWindowTitle(window, "KPGR3 Example02");
